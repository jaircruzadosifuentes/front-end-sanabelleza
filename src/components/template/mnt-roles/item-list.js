...
export default function WrappedMenuItems({
  ...
  return (
    <div>
      ...
      >
        <MenuSection label={('MANTENIMIENTO DE CARGOS').substring(0, 30)}>
          <small>{label.substring(0, 30)}</small>
          <StyledMenuItem onClick={(e) =>handleEditar(e, row)} style={{cursor: 'pointer'}}>
            <EditIcon />  Editar Cargo
          </StyledMenuItem>
          <StyledMenuItem onClick={(e) =>handleDisabledEnabled(e, row, 1)} style={{cursor: 'pointer'}}>
            <NotInterestedIcon /> Deshabilitar
          </StyledMenuItem>
          <StyledMenuItem onClick={(e) =>handleDisabledEnabled(e, row, 2)} style={{cursor: 'pointer'}}>
            <CheckCircleIcon /> Habilitar
          </StyledMenuItem>
        </MenuSection>
      </Menu>
    </div>
